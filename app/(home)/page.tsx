    ...
    <div className={"h-full w-full"}>
      ...
      >
        <div className={"flex flex-col gap-y-7  items-center"}>
          ...
          <div className={"w-full sm:w-3/4 mx-auto"}>
            <p className={"text-center text-base md:text-lg"}>
              ...
              educational experiences, fostering confidence and curiosity. Core
              values include excellence, equity, and empowerment, providing
              children with unforgettable journeys beyond their borders.
            </p>
          </div>
        </div>
        <div className={"flex flex-col gap-y-7  items-center"}>
        ...
        <div className={"w-full sm:w-3/4 mx-auto"}>
          <p className={"text-center text-base md:text-lg"}>
            These destinations offer a mix of historical, cultural, and
            recreational experiences that can provide children with a broad and
            enriching perspective on the UK.
          </p>
        </div>
      </section>
      <section
