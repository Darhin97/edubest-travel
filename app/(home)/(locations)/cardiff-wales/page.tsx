      ...
      <div className={"py-10"}>
        ...
        <div className={"lg:w-4/5  mx-auto mt-4 md:mt-9 flex flex-col gap-y-4"}>
          <p className={"text-center text-base "}>
            Cardiff Castle: A medieval fortress with 2,000 years of history. St
            Fagans National Museum of History: An open-air museum depicting
            Welsh life across centuries.
          </p>
          <ul className={" px-4 lg:pl-10 space-y-1 "}>
            <li className={"list-disc"}>
              Cardiff Castle: Explore this medieval castle with over 2,000 years
              of history.
            </li>
            <li className={"list-disc"}>
              Fagans National Museum of History: An open-air museum showcasing
