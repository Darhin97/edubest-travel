      ...
      <div className={"py-10"}>
        ...
        <div className={"lg:w-4/5  mx-auto mt-4 md:mt-9 flex flex-col gap-y-4"}>
          <p className={"text-center text-base "}>
            Explore Edinburgh Castle&apos;s royal history, the National Museum
            of Scotland&apos;s diverse exhibits, and Edinburgh Zoo&apos;s global
            wildlife, including giant pandas.
          </p>
          <ul className={" px-4 lg:pl-10 space-y-1 "}>
            <li className={"list-disc"}>
              Edinburgh Castle: Explore this historic fortress and learn about
              Scotland&apos;s royal history.
            </li>
            <li className={"list-disc"}>
              The National Museum of Scotland: Discover everything from Scottish
              history to natural wonders.
            </li>
            <li className={"list-disc"}>
              Edinburgh Zoo: Meet animals from around the world, including the
              famous giant pandas.
            </li>
          </ul>
        </div>
